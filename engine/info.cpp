...
{
	if (*key != '*' && Q_strcmp(key, "name") && Q_strcmp(key, "model") && Q_strcmp(key, "rate") && Q_strcmp(key, "topcolor") && Q_strcmp(key, "bottomcolor") && Q_strcmp(key, "cl_updaterate") && Q_strcmp(key, "cl_lw") && Q_strcmp(key, "cl_lc") && Q_strcmp(key, "*hltv") && Q_strcmp(key, "*sid"))
	{
		return false;
	}
