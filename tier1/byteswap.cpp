...
//-----------------------------------------------------------------------------
template <class T>
bool IsByteSwapped(T input, T nativeConstant)
{
...
//-----------------------------------------------------------------------------
template <class T>
void SwapBufferToTargetEndian(T* outputBuffer, T* inputBuffer, int count)
{
	assert(count >= 0);
	assert(outputBuffer);
