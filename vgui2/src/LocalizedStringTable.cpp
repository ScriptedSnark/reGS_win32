...
CLocalizedStringTable::CLocalizedStringTable()
	: m_Values(2048), m_FastValueLookup(&CLocalizedStringTable::FastValueLessFunc), m_Lookup(&CLocalizedStringTable::SymLess), m_Names(1024)
{
}
...
{
	const char* pszLhs = lhs.nameIndex == vgui2::INVALID_STRING_INDEX ? g_LessCtx.m_pUserString : &g_LessCtx.m_pTable->m_Names[lhs.nameIndex];

	const char* pszRhs = rhs.nameIndex == vgui2::INVALID_STRING_INDEX ? pszRhs = g_LessCtx.m_pUserString : &g_LessCtx.m_pTable->m_Names[rhs.nameIndex];
